...
<head>
    ...
    <link rel="shortcut icon" href="https://media.istockphoto.com/id/1296839242/vector/b-letter-logo.jpg?s=612x612&w=0&k=20&c=fu-mPPfikR9CWCVW1VEzcBr23XqtYzTzJgmxUbC8FLA=" type="image/x-icon">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>@yield('title')</title>
    {!! Html::style('/css/admin/main.d810cf0ae7f39f28f336.css') !!}
    {!! Html::style('/css/admin/css/all.min.css') !!}
</head>
...
<body>
    ...
    {!! Html::script('/js/admin/main.d810cf0ae7f39f28f336.js') !!}
